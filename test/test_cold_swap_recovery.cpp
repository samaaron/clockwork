...
/*
 * test_cold_swap_recovery.cpp — rebuild failure recovery.
 *
 * When the guest rebuild throws during a cold swap, the engine should fall
...
TEST_CASE("ColdSwapRecovery: rebuild failure recovers at safe defaults",
    ...
    // The cold swap rebuilds the guest, which throws — the engine recovers
