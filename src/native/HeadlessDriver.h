...
public:
    ...
    // The engine's dashboard block, mirrored into per block; null skips it.
...
private:
    // Shared loop body: derive NTP via ClockworkClock,
    ...
    // ClockworkEngine::Config so the tick rate is deterministic and
