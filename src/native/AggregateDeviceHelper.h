...
//
// The aggregate device is named "clockwork" and there is only ever
// one managed instance at a time.
// desiredSampleRate: the rate the engine wants to run at (the DSP is
// initialised at it, as is JUCE's setup.sampleRate that we
