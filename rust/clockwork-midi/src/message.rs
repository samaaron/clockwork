...
//! Channels are exposed **1-based** (1..=16), as musicians count them; the wire
//! bytes are 0-based and converted here.
//!
...
pub enum MidiMessage {
    ...
    /// Polyphonic key pressure (0xA0) — often called aftertouch.
...
impl MidiMessage {
    ...
    /// The `/clockwork/midi/in/*` address suffix for this message (e.g. `"note_on"`).
    /// This is the single source of truth for the message kind — both the OSC
    /// schema ([`crate::schema::encode_in`]) and the structured web boundary
