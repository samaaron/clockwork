...
// Pre-allocated encode buffer. Generous because a synthdef is a single
// message and the largest this system sends is about 13 KB; bulk does not come
// through here at all — a sample goes into shared memory and only its address
// rides OSC (/b_allocPtr), which is what the one-way lanes are for.
...
// String cache for addresses (they repeat constantly)
...
// tag string (OSC array tags, used by the engine's n_setn-style controls).
