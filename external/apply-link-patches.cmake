# Apply the tau Link patches idempotently, run from the Link source
...
if(reverse_check EQUAL 0)
    message(STATUS "[tau-link-patches] already applied — skipping")
    return()
endif()
...
if(forward_check EQUAL 0)
    message(STATUS "[tau-link-patches] applying patches")
    execute_process(
        COMMAND ${GIT_EXECUTABLE} apply --ignore-whitespace --whitespace=nowarn ${PATCHES}
        RESULT_VARIABLE apply_result
    )
    if(NOT apply_result EQUAL 0)
        message(FATAL_ERROR "[tau-link-patches] git apply failed")
    endif()
    return()
endif()

message(FATAL_ERROR
    "[tau-link-patches] patches don't apply cleanly to this Link source.\n"
